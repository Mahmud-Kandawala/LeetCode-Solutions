class Solution:
    def removeDuplicates(self, nums: List[int]) -> int:
        ...
        l = 1 #Keep track of the position in the list nums (left)

        for r in range(1,len(nums)): # Iterate over the indices of the list nums, starting from index 1 (the second element) to the last index. The variable r (right) represents the current index in the loop.
